                                ...
                                <div id="product">
                                    ...
                                    <div class="cart">
                                        ...
                                        <div>
                                            ...
                                            @else
                                            <button type="button" id="button-cart" class="btn btn-primary btn-lg">ناموجود</button>
                                            @endif
                                        </div>
                        ...
                        @foreach($like_products as $item)
                            <div class="product-thumb">
                                ...
                                <div class="button-group">
                                    ...
                                    @else
                                        <button class="btn-primary" type="button"><span>ناموجود</span></button>
                                    @endif                                     <div class="add-to-links">
                                        @php
