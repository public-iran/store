...
@section('content')
    ...
    <div class="container" style="position:relative;">
        <div class="mobile-navigation">
            <ul> <li>
                    <a href="javascript:void(0)" class="mobile-menu-icon" id="mobile-menu-trigger2"><i class="lnr lnr-menu"></i></a>
                </li></ul>

        </div>
        <aside id="main-sidebar" class="main-sidebar">
            <!-- sidebar: style can be found in sidebar.less -->
            <a class="offcanvas-menu-close" id="offcanvas-menu-close-trigger">
