...
@section('Admin_content')
    ...
    <div class="col-xs-12 head" style="margin-bottom: 20px;display: flex;justify-content: space-between">
        <div style="width: 100%">
            <h2>
                ...
                <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">افزودن کد تخفیف جدید</b>
            </h2>
    ...
    <form action="{{route('discountcodes.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" id="slug" name="darsad"
                                                   class="form-control" value="{{old('darsad')}}">
                        ...
                        <div class="col-xs-12 col-lg-12 ali-m-bottom-6" style="background: white;padding-top: 20px">
                            <div class="body">
                                <div class="col-lg-12" style="display: grid">
                                    <input type="submit" value="ایجاد کد تخفیف"
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input  type="number" id="title" name="max"
                                            class="form-control" value="{{old('max')}}">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="pdpSelectedBefore" name="end_date"
                                                           ...
                                                           placeholder="تاریخ اتمام تخفیف" value="{{old('end_date')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
