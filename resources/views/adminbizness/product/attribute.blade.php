    ...
    <div class="col-xs-12 head" style="margin-bottom: 20px;display: flex;justify-content: space-between">
        <div style="width: 100%">
            <h2>
                ...
                <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">ویژگی های {{str_limit($product->title,60)}}</b>
            </h2>
            ...
            <div class="card" style="box-shadow: none">
                ...
                <div class="body">
                    ...
                    <form method="post" action="{{route('attribute_create')}}">
                        @csrf
                        @foreach($category_ids as $attr)
                            @php $attributes=App\Attribute::where('category_id',$attr)->with('attribute_values')->select('id', 'title')->distinct()->get(); @endphp
