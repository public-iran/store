...
@section('Admin_content')
    ...
    <form action="{{route('PostCategory.update',$category->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        {{ method_field('PATCH') }}
        <div class="row">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input onkeyup="convertToSlug()" type="text" id="title" name="title"
                                                   class="form-control" value="@if(old('title')==""){{$category->title}} @else{{old('title')}}@endif">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="slug" name="slug"
                                                   class="form-control" value="@if(old('slug')==""){{$category->slug}} @else{{old('slug')}}@endif">
