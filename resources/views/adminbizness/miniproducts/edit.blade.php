...
@section('Admin_content')
    ...
    <div class="row">
        ...
        {!! Form::model($miniproduct, ['method' => 'PATCH', 'action' => ['AdminB\AdminminiproductsController@update', $miniproduct->id], 'files' => true]) !!}
            @csrf
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    {{ Form::select('status', ['0' => 'پیش نویس', '1' => 'انتشار'], null, ['class' => 'selectpicker form-control show-tick']) }}
                                                </div>
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <div class="row clearfix">
                                            <div class="col-lg-12">
                                                <div class="form-group form-float">
                                                    {{ Form::select('package', ['1' => 'پکیج یک', '2' => 'پکیج دو', '3' => 'پکیج سه', '4' => 'پکیج چهار'], $miniproduct->package, ['class' => 'selectpicker form-control show-tick']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-12">
                                                <img width="250px" style="max-height: 250px" class="img-fluid" src="{{asset($miniproduct->image)}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
