                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <select required id="position" onchange="change_position(this,{{$banner->id}})"
                                                    ...
                                                    <option value="center" @if($banner->position=="center")selected @endif>بنر وسط</option>
                                                    <option value="bottom" @if($banner->position=="bottom")selected @endif>بنر پایین</option>
                                                </select>
                                            </div>
