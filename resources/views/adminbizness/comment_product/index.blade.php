                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            ...
                            <small><a href="/product/{{@$comment->product->slug}}">مشاهده محصول</a></small>
                        </h2>
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    @endif
                                    <li onclick="answer('{{$comment->id}}','{{$comment->product_id}}')"><a href="javascript:void(0);" data-toggle="modal" data-target="#exampleModal">پاسخ</a>
                                    </li>
                    ...
                    <div class="body">
                        <span style="float: right;width: 100%">
                         ...
                         <?php
                            $answers=App\Comment::where('parent',$comment->id)->get();
                        ?>
    ...
    <div class="modal ali-modal" id="exampleModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="answer" action="{{route('comment-product.store')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content1" style="border: 1px solid #eee;padding:10px;border-radius: 5px;"
...
@section('script')
    <script>
        ...
        function comment_status(tag, status, id) {
            $.ajax({
                url: '{{route('product-comment-ajax')}}',
                method: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token()}}",
        ...
        function comment_delete(tag, id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{route('product-comment-ajax-delete')}}',
                        method: "POST",
                        cache: false,
                        data: {
                            "_token": "{{ csrf_token()}}",
