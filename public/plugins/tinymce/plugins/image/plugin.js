...
tinymce.PluginManager.add('image', function(editor) {
	...
	function showDialog(imageList) {
		...
		function onSubmitForm() {
			...
			editor.undoManager.transact(function() {
				...
				if (data.caption === false) {
					if (dom.is(imgElm.parentNode, 'figure.photos')) {
		...
		figureElm = dom.getParent(imgElm, 'figure.photos');
		if (figureElm) {
	...
	editor.addButton('image', {
		icon: 'image',
		tooltip: 'Insert/edit photos',
		onclick: createImageList(showDialog),
		stateSelector: 'img:not([data-mce-object],[data-mce-placeholder]),figure.photos'
	});

	editor.addMenuItem('image', {
		icon: 'image',
		text: 'Insert/edit photos',
		onclick: createImageList(showDialog),
		context: 'insert',
