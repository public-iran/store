 ...
 * it will make a link out of the current selection. If it's an photos url that looks
 * like an photos it will check if it's an photos and insert it as an photos.
 *
...
define("tinymce/pasteplugin/Clipboard", [
	...
	return function(editor) {
		...
		/**
		 * Checks if the clipboard contains photos data if it does it will take that data
		 * and convert it into a data url photos and paste that photos at the caret location.
		 *
		 * @param  {ClipboardEvent} e Paste/drop event object.
		 * @param  {DOMRange} rng Rng object to move selection to.
		 * @return {Boolean} true/false if the photos data was found or not.
		 */
