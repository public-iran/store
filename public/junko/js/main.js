(function ($) {
	...
	$(".widget_sub_categories2 > a").on("click", function () {
		$(this).toggleClass('active');
		$('.widget_dropdown_categories2').slideToggle('medium');
	});

	/*---addClass/removeClass categories---*/
	$("#cat_toggle.has-sub > .before-icon").on("click", function () {
		$(this).toggleClass('open').next('.categorie_sub').toggleClass('open');
		$(this).parent('.has-sub').find('a').toggleClass('open').next('.categorie_sub').toggleClass('open');
	});
    $("#cat_toggle2.has-sub > .before-icon").on("click", function () {
        $(this).toggleClass('open').next('.categorie_subb').toggleClass('open');
        $(this).parent('.has-sub').find('a').toggleClass('open').next('.categorie_subb').toggleClass('open');
    });
	/*---MailChimp---*/
	$('#mc-form').ajaxChimp({
		language: 'en',
